...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            int latitudeIdx      = cursor.getColumnIndex("latitude");
            int longitudeIdx     = cursor.getColumnIndex("longitude");

            while (cursor.moveToNext()) {

                String nameFromDatabase         = cursor.getString(nameIdx);
                String latitudeFromDatabase     = cursor.getString(latitudeIdx);
                String longitudeFromDatabase    = cursor.getString(longitudeIdx);
